...
const ClientPostTaskComponent = () => {
    ...
    const onSubmitTask = async (data) => {
        ...
        try {
            ...
            // Fetch the client token dynamically right before sending the mutation request
...
export default ClientPostTaskComponent;